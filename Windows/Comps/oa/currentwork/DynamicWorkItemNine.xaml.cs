...
namespace IDKin.IM.Windows.Comps.OA.CurrentWork
{
	...
	public partial class DynamicWorkItemNine : TableRow//, IComponentConnector
	{
		...
		public DynamicWorkItemNine()
		{
			this.InitializeComponent();
		}
		public DynamicWorkItemNine(string date, string fromName, string afterNameOne, string afterNameTwo, string afterNameThree, string afterNameFour, string afterNameFive, string afterNameSix, string afterNameSeven, string url)
		{
			this.InitializeComponent();
		...
		public void UseStyle(DynamicWorkItemNineStyle style)
		{
		}
        ...
        //        Uri resourceLocater = new Uri("/IDKin.IM.Windows;component/comps/oa/currentwork/dynamicworkitemnine.xaml", UriKind.Relative);
