...
namespace IDKin.IM.Windows.View.EmailAlert
{
    ...
    public partial class CommonEmailItem : TabItem//, IComponentConnector
	{
		...
		private void Initial()
		{
			System.Collections.Generic.List<EmailServerInfo> EmailServerInfos = new System.Collections.Generic.List<EmailServerInfo>
			{
				new EmailServerInfo
				{
					URL = "https://edit.bjs.yahoo.com/config/login?.done=\"http://cn.mail.yahoo.com/inset.html\"&login={0}&passwd={1}",
					Server = "pop.mail.yahoo.com",
					Text = "yahoo.com.cn"
				},
				new EmailServerInfo
				{
					URL = "https://reg.163.com/logins.jsp?username={0}&password={1}&url=http://entry.mail.126.com/cgi/ntesdoor?verifycookie=1",
					Server = "pop.126.com",
					Text = "126.com"
				}
			};
			this.cboxServer.ItemsSource = EmailServerInfos;
		...
		private void btnOpen_Click(object sender, RoutedEventArgs e)
		{
			...
			this.mailId = string.Format("{0}@{1}", this.txtID.Text.Trim(), (this.cboxServer.SelectedItem as EmailServerInfo).Text);
		...
		{
			this.tbkMsg.Text = string.Empty;
			if (string.IsNullOrWhiteSpace(this.txtID.Text) || string.IsNullOrWhiteSpace(this.txtPwd.Password) || this.cboxServer.SelectedItem == null)
			{
				this.btnOpen.IsEnabled = false;
			}
			else
        ...
        //        Uri resourceLocater = new Uri("/IDKin.IM.Windows;component/view/emailalert/commonemailitem.xaml", UriKind.Relative);
        ...
        //        break;
        //    case 2:
        //        this.cboxServer = (ComboBox)target;
        //        this.cboxServer.SelectionChanged += new SelectionChangedEventHandler(this.cboxServer_SelectionChanged);
        //        break;
        //    case 3:
